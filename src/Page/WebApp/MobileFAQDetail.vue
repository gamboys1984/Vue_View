...
<!-- <router-link to="mobile/mint">asdfasdfsadfsadf</router-link>   -->
    <div id="all">
        ...
        <MobileImgInfo ref="jisuanimgf" v-show="hide" @hideImg="showlDialog"></MobileImgInfo>
...
<script>
    ...
    import MobileImgInfo from '@/components/WebApp/MobileImgInfo'
        ...
        Enlarge: function(imgsrc){ //点击图片放大
            ...
            var int=self.setInterval(function(){
              ...
              if(img.height != 0){
                ...
                var _this=this;
                _this.$refs.jisuanimgf.JiSuanImg(imgsrc)
               // this.ShowZhezhao();
              }
            }.bind(this),50)
